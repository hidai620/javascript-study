...
/***/ function(module, exports, __webpack_require__) {
	...
	(function webpackMissingModule() { throw new Error("Cannot find module \"mocha!./test/test.js\""); }());
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('app', '<nav><a each="{data}" href="#{id}">{title}</a></nav> <article> <h1>{page.title || \'Not found\'}</h1> <p>{page.body || \'Specified id is not found.\'}</p> </article>', 'app,[riot-tag="app"],[data-is="app"]{ display: block; font-family: sans-serif; margin: 0; padding: 1em; text-align: center; color: #666; } app nav,[riot-tag="app"] nav,[data-is="app"] nav{ display: block; border-bottom: 1px solid #666; padding: 0 0 1em; } app nav > a,[riot-tag="app"] nav > a,[data-is="app"] nav > a{ display: inline-block; padding: 0 .8em; } app nav > a:not(:first-child),[riot-tag="app"] nav > a:not(:first-child),[data-is="app"] nav > a:not(:first-child){ border-left: 1px solid #eee; }', '', function (opts) {
	  "use strict";
